"""
Trash Detection System with Tkinter GUI - OPTIMIZED FOR HIGH FPS
...
class TrashDetectorGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("Trash Detection System - AI Recycling Classifier (OPTIMIZED)")
    ...
    def setup_left_panel(self, parent):
        ...
        ttk.Label(title_frame, text="⚡ OPTIMIZED", font=("Arial", 9), foreground="green").pack()
    ...
    def open_camera(self):
        ...
        try:
            ...
            # Configure camera for better FPS
